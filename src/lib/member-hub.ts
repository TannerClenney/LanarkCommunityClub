...
export function getDashboardTaskLists(memberName?: string | null) {
  ...
  return {
    needsAHand: [
      ...
      {
        id: "need-bartend-friday",
        title: "Help bartend Friday",
        description: "Bartend the main shift, keep service moving, and coordinate quick cooler checks.",
        timeLabel: "Friday, 3:00 PM-11:00 PM",
        status: "open" as const,
        eventSlug: "old-settlers-days",
        eventTitle: "Old Settlers Days / Beer Tent",
      ...
      {
        id: "need-bartend-sat-day",
        title: "Help bartend Saturday daytime",
        description: "Cover daytime bartending and keep lines steady through afternoon traffic.",
        timeLabel: "Saturday, 10:00 AM-5:00 PM",
        status: "open" as const,
        eventSlug: "old-settlers-days",
        eventTitle: "Old Settlers Days / Beer Tent",
        areaSlug: "beer-service",
      ...
      {
        id: "need-bartend-sat-evening",
        title: "Help bartend Saturday evening",
        description: "Cover evening bartending and help close up the beer tent at shift end.",
        timeLabel: "Saturday, 5:00 PM-11:00 PM",
        status: "open" as const,
        eventSlug: "old-settlers-days",
        eventTitle: "Old Settlers Days / Beer Tent",
        areaSlug: "beer-service",
    ...
    areas: [
      ...
      },
      {
        ...
        tasks: [
          ...
          {
            id: "beer-saturday-daytime-bartending",
            title: "Help bartend Saturday daytime",
            description: "Cover daytime bartending and keep lines steady through afternoon traffic.",
            timeLabel: "Saturday, 10:00 AM-5:00 PM",
            status: "open",
          ...
          {
            id: "beer-saturday-evening-bartending",
            title: "Help bartend Saturday evening",
            description: "Cover evening bartending and help close up the beer tent at shift end.",
            timeLabel: "Saturday, 5:00 PM-11:00 PM",
            status: "open",
